        ...
        <div id="content-container">
          {activeTab === 'about' && (
            <div className={`content ${activeTab === 'about' ? 'active' : ''}`}>
              ...
              In 2024 I recieved my asscoiate degree from Broward College with honors. Shortly after I began attending Florida Atlantic University for my bachelor's, majoring in Computer Science, and minoring in Artifical Intelligence.<br/><br/>
              I currently live in West Palm Beach, FL with amazing girlfriend and our three awesome Siberian Huskies; Medusa, Leo, and Forrest.<br/><br/>
